<template>
  <div class="footer-wrapper">
    <div class="footer">
      ...
      <router-link class="footerTab" to="/discover">
        <svg class="footerTabIcon">
           <use :xlink:href="$route.path.indexOf('discover') !== -1? '#findActive' : '#find'"></use>
        </svg>
        <span class="text">发现</span>
      </router-link>
      <router-link class="footerTab" to="/order">
        <svg class="footerTabIcon">
            <use :xlink:href="$route.path.indexOf('order') !== -1? '#orderActive' : '#order'"></use>
        </svg>
        <span class="text">订单</span>
      </router-link>
      <router-link class="footerTab" to="/profile">
        <svg class="footerTabIcon">
